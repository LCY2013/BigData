package com.lcydream.open.project.logenhance;
...
public class LogEnhanceOutputFormat extends FileOutputFormat<Text, NullWritable> {
	...
	public RecordWriter<Text, NullWritable> getRecordWriter(TaskAttemptContext context) throws IOException, InterruptedException {
		...
		//Path enhancePath = new Path("hdfs://master130:9000/logenhance/enhancedlog/log.dat");
		//Path tocrawlPath = new Path("hdfs://master130:9000/logenhance/tocrawl/url.dat");
